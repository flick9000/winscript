...
- Автоматический поиск и установка драйверов для устройств Windows (через PowerShell и pnputil)
- Вкладка "Драйверы" в интерфейсе: автопоиск, ручная установка по .inf
- Улучшена интеграция с Tauri и Astro
