...
const TRANSLATIONS = {
  ru: {
    ...
    "If you enjoy using WinScript, please consider supporting the project! You can star the project on GitHub or donate to help keep development going. Every bit of support helps keep WinScript open-source and improving for everyone.":
      "Если вам нравится WinScript, поддержите проект! Вы можете поставить звезду на GitHub или сделать донат — это помогает развивать WinScript и сохранять его открытым и бесплатным для всех.",
